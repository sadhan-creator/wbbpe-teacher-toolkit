...
if (startIndex !== -1 && endIndex !== -1) {
  ...
  }, [teacherName, designation, schoolName, circleName]);
  ...
  const generateLetterText = () => {
    ...
    if (lang === 'bn') {
      const schCirc = circleName ? \`\${schoolName || '[বিদ্যালয়ের নাম]'}, \${circleName}\` : \`\${schoolName || '[বিদ্যালয়ের নাম]'}\`;
      letter = \`প্রতি,\\n\${recipient}\\n\${schCirc}\\n\\n\`;
      ...
      if (leaveType === 'advance') {
        letter += \`   বিনীত নিবেদন এই যে, আমি আপনার বিদ্যালয়ের \${designation}। আমার \${displayReason || '______'}-এর জন্য আগামী \${formattedFrom} হইতে \${formattedTo} পর্যন্ত মোট \${displayDays} দিনের নৈমিত্তিক ছুটি (CL) গ্রহণ করা একান্ত প্রয়োজন।\${prefixSuffixText}\\n\\n\`;
        letter += \`অতএব, আপনার নিকট বিনীত প্রার্থনা, অনুগ্রহপূর্বক উক্ত দিনগুলির নৈমিত্তিক ছুটি মঞ্জুর করিয়া বাধিত করিবেন।\`;
      } else {
        letter += \`   বিনীত নিবেদন এই যে, আমি আপনার বিদ্যালয়ের \${designation}। আমি বিগত \${formattedFrom} হইতে \${formattedTo} পর্যন্ত মোট \${displayDays} দিন \${displayReason || '______'}-এর কারণে বিদ্যালয়ে উপস্থিত হইতে পারি নাই। আমি অদ্য \${formattedJoining} তারিখে বিদ্যালয়ে নিয়মিত দায়িত্বে যোগদান করিলাম।\${prefixSuffixText}\\n\\n\`;
      ...
      const schCirc = circleName ? \`\${schoolName || '[School Name]'}, \${circleName}\` : \`\${schoolName || '[School Name]'}\`;
      letter = \`To,\\n\${recipient}\\n\${schCirc}\\n\\n\`;
      ...
      if (leaveType === 'advance') {
        letter += \`   With due respect, I would like to state that I am serving as \${designation} in your school. I need to take \${displayDays} day(s) of Casual Leave (CL) from \${formattedFrom} to \${formattedTo} due to \${displayReason || '______'}.\${prefixSuffixText}\\n\\n\`;
        letter += \`I, therefore, request you to kindly grant me casual leave for the aforementioned period and oblige.\`;
      } else {
        letter += \`   With due respect, I would like to state that I am serving as \${designation} in your school. I could not attend school for \${displayDays} day(s) from \${formattedFrom} to \${formattedTo} due to \${displayReason || '______'}. I have resumed my regular duties at the school today, \${formattedJoining}.\${prefixSuffixText}\\n\\n\`;
      ...
      {isOpen && (
        <div style={{ background: '#ffffff', padding: '16px', borderRadius: '12px', border: '1px solid #e2e8f0', marginTop: '8px', boxShadow: '0 4px 6px -1px rgba(0,0,0,0.05)' }}>
          ...
          <div style={{ marginBottom: '16px' }}>
            ...
            {showPreview && (
              <div style={{ marginTop: '8px', padding: '12px', background: '#f8fafc', border: '1px solid #cbd5e1', borderRadius: '8px', fontSize: '11px', whiteSpace: 'pre-wrap', lineHeight: 1.5, color: '#334155', maxHeight: '300px', overflowY: 'auto', boxShadow: 'inset 0 2px 4px rgba(0,0,0,0.02)' }}>
                <div style={{ textAlign: 'right', marginBottom: '8px', color: '#94a3b8' }}>
                  {lang === 'bn' ? \`তারিখ: \${currentFormattedDate}\` : \`Date: \${currentFormattedDate}\`}
                </div>
                {generateLetterText()}
              </div>
            )}
...
`;
  ...
  console.log('Successfully updated LeaveApplicationGenerator with post-facto and preview logic');
} else {
